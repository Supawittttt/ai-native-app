...
const slides: SlideData[] = [
  {
    icon: Bot,
    title: 'AI Chatbot',
    description: 'Chatbot อัจฉริยะที่ตอบคำถามจากเอกสารองค์กร รองรับทั้ง Web และ LINE Messaging API',
    image:
      ...
      <div className='relative flex h-full flex-col justify-end p-12'>
        <div className='space-y-6'>
          ...
          <div className='flex items-center gap-3'>
            ...
            <span className='text-lg font-light text-purple-300'>AI Native App</span>
          </div>

          {/* Title */}
          <h2 className='text-3xl font-bold leading-tight text-white'>{current.title}</h2>
          ...
          <div className='flex flex-wrap gap-2 pt-2'>
            {['Next.js 16', 'Better Auth', 'Prisma v7', 'pgVector', 'OpenAI'].map((tech) => (
              <span
                key={tech}
          ...
          {slides.map((slide, index) => (
            <button
              ...
              className={cn(
                ...
                activeIndex === index ? 'w-8 bg-white' : 'w-2 bg-gray-500 hover:bg-gray-400'
              )}
