        ...
        <div className='grid gap-12 lg:grid-cols-2 lg:items-center'>
          ...
          <div>
            ...
            <p className='mb-6 text-muted-foreground leading-relaxed'>
              AI Native App คือโปรเจกต์ต้นแบบที่พัฒนาจากหลักสูตร &quot;Next.js 16: The AI-Native
              Developer Masterclass&quot; ครอบคลุมการสร้างแอปพลิเคชันครบวงจรตั้งแต่ Authentication,
              RAG Knowledge Base, AI Chatbot ไปจนถึง LINE Integration และ Production Deployment
            </p>
            <p className='text-muted-foreground leading-relaxed'>
              เหมาะสำหรับนักพัฒนาที่ต้องการเรียนรู้การสร้าง AI Application ด้วยเทคโนโลยียุคใหม่แบบ
              hands-on ทำจริงทุกขั้นตอน
            </p>
          </div>
